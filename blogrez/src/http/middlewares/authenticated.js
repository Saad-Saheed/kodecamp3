...
function authenticated(req, _res, next){
    ...
    if (!authorizationHeader || !authorizationHeader.startsWith("Bearer")) {
        throw new ApiCustomError("Access Denied, kindly login.", StatusCodes.UNAUTHORIZED);
    }
    ...
    try{
        ...
        throw new ApiCustomError(`Access Denied, kindly login. ${error.message}`, StatusCodes.UNAUTHORIZED);   
    }
}
